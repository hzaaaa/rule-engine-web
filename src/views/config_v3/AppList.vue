<template>
  <div class="app">
    <el-button type="primary" class="app-btn" @click="openDrawer('新增')">新增</el-button>
    <div class="app-list">
    ...
    <!-- 创建/编辑 app 弹窗 -->
    <el-dialog v-model="dialogFormVisible" :title="dialogProps.title" width="600">
      <el-form :model="dialogProps.row" :rules="rules">
...
import { getAppListPageApi, postAppAddApi, postAppUpdateApi, postAppDeleteApi } from "@/api/engine/engine_v3";
...
const jumpToBaseList = (appId: number) => {
  routeQueryStore.setRouteQueryState("appId", appId);
  router.push(`/model/list_v3`);
};
const refreshTableData = () => {
  getAppListPageApi().then((res) => {
